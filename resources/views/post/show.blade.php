    ...
    <main class="blog-post">
        <div class="container">
            <h1 class="edica-page-title"
               data-aos="fade-up">{{$post->title}}</h1>
            <p class="edica-blog-post-meta"
              data-aos="fade-up" data-aos-delay="200">{{$date->translatedFormat('F')}}{{$date->day}}, {{$date->year}}  {{$date->format('H:i')}}. {{$post->comments->count()}}</p>
            ...
            <section class="post-content">
                ...
                <div class="row mb-5">
                    <div class="col-md-4 mb-3" data-aos="fade-right">
                        <img src="" alt="blog post" class="img-fluid">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    <section class="related-posts">
                        <h2 class="section-title mb-4" data-aos="fade-up">Cхожие посты</h2>
                        <div class="row">
