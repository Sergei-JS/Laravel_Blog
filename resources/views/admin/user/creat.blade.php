            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form action="{{route('admin.user.store')}}" method="POST" class="w-25">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="email" placeholder="почта пользователя" value="{{old('email')}}">
                            @error('email')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <input type="submit" class="btn-outline-primary" value="Добавить">
                    </form>
                </div>
                <!-- /.row -->
